        ...
        return this.each(function () {
            ...
            elem.on('click', function () {
                ...
                function createCalendar(selectedMonth) {
                    ...
                    for (var i = 0; i < 7; i++) {
                        var $e = $('<div>');
                        $e.addClass('dtp_modal-calendar-cell dtp_modal-colored is-remark');
                ...
                function createMonthPanel(selectMonth) {
                    ...
                    var $s = $('<img src="/statics/icon/angle-left.svg">');
                    ...
                    $d.append($s);
                    $s = $('<img src="/statics/icon/angle-right.svg">');
                ...
                function attachChangeTime() {
                    var $angles = $($content).find('.icon[id^="angle-"]');
                ...
                function createContent() {
                    ...
                    var $wrapper = $('<div>');
                    $wrapper.addClass('dtp_modal-wrapper');
                    ...
                    if (settings.showTime) {
                        ...
                        $line.text('발송 시간: '+lastSelected.format(settings.dateFormat));

                        $a.append(createTimer());
                        $a.append($line);

                        var $but = $('<div>');
                        $but.addClass('button button--primary is-large dpt_modal-button');
